  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 text-white">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {data?.map(post => (
          <Link key={post.id} href={`/Blog/${post.slug}`} className="bg-[#242433] rounded-lg overflow-hidden hover:ring-2 ring-[#58587B] transition">
            {post.cover && (
            ...
            <div className="p-4">
              ...
              <div className="text-sm text-[#9ea0c7]">{new Date(post.created_at).toLocaleDateString('uk-UA')}</div>
