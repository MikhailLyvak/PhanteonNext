			...
			>
				<div className='flex justify-between w-full '>
					<div className='flex sm:mb-6 items-center flex-1 min-w-0'>
						<div
							className={`w-6 h-6 flex items-center justify-center rounded-full ${data.module_progress === 100 ? 'bg-[#D2D2FF] text-[#242433]' : 'border-gray-500 border-[1px] text-white'}  shrink-0`}
						>
							<LuCheck size={18} />
						</div>
				...
				{data.mine ? (
					<div className='flex items-center gap-4 w-full mt-3 lg:mt-8'>
						...
						<div className='text-xl font-semibold text-[#D2D2FF]'>
