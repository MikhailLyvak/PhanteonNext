			...
			<ProtectedRoute>
				<div className='pt-2 max-w-7xl mx-auto'>
					<div className='flex flex-col max-lg:mx-4'>
						...
						<div className='hidden lg:flex text-[#D2D2FF] text-4xl font-semibold mt-6'>
							{data?.name}
						</div>
									...
									{data?.videos === null ? (
										...
										data?.videos[0] !== null && (
											<iframe
												...
												src={`https://www.youtube.com/embed/${getYouTubeId(data?.videos)}`}
